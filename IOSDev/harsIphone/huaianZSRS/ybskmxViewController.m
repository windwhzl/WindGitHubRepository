...
@interface ybskmxViewController ()

@end

@implementation ybskmxViewController
            ...
            currentPage:(int)page
{
    ...
    JsonURLString = [NSString stringWithFormat:@"%@%@",[HttpUtil getUrl],@"zsrs-sb/yb/ybAction!ybmx"];
...
-(UITableViewCell *) tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    UINib *nib;
    CellTableIdentifier = @"ybskmxDetailTableCell";
    nib =[UINib nibWithNibName:@"ybskmxDetailTableViewCell" bundle:nil];
    [tableView registerNib:nib forCellReuseIdentifier:CellTableIdentifier];
    
    ybskmxDetailTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:CellTableIdentifier];
    
    NSDictionary *rowData = self.dataList[indexPath.row];
    float xiaofeiString = [rowData[@"akc255"] floatValue];
    float yueSting = [rowData[@"akc252"] floatValue];
    float yueFloatValue = yueSting - xiaofeiString;
    
    NSString *xiaofeiResultString = [NSString stringWithFormat:@"%.2lf",xiaofeiString];
    NSString *yueResultString = [NSString stringWithFormat:@"%.2lf",yueFloatValue];
    
    NSString *xiaofei = [NSString stringWithFormat:@"本次消费:%@￥",xiaofeiResultString];
    NSString *yue = [NSString stringWithFormat:@"账号余额:%@￥",yueResultString];
    cell.hosNameString = rowData[@"akb020"];
    cell.dateString = rowData[@"aae040"];
    cell.xiaofeiString = xiaofei;
    cell.yueString = yue;
    return cell;
}
