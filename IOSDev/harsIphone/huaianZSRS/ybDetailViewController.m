...
@interface ybDetailViewController ()

@end

@implementation ybDetailViewController
            ...
            currentPage:(int)page
{
    ...
    JsonURLString = [NSString stringWithFormat:@"%@%@",[HttpUtil getUrl],@"zsrs-sb/yb/ybAction!ybye"];
...
-(UITableViewCell *) tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    UINib *nib;
    CellTableIdentifier = @"ybcxDetailTableCell";
    nib =[UINib nibWithNibName:@"ybcxDetailTableViewCell" bundle:nil];
    [tableView registerNib:nib forCellReuseIdentifier:CellTableIdentifier];
    
    ybcxDetailTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:CellTableIdentifier];
    
    NSDictionary *rowData = self.dataList[indexPath.row];
    cell.nf = rowData[@"aae001"];
    cell.snzr= rowData[@"akc080"];
    cell.zhye = rowData[@"akc087"];
    cell.jnys = rowData[@"akc085"];
    cell.zchj =rowData[@"akc093"];
    return cell;
}
